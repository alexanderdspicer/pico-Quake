...
//Theory Craft better idea
//	Bitwise compare 32-bit magic number with x and y coords to move player in direction 
//	normal to (should the below blurb be correct) the faces which the character is stuck in
/*
=====================
SV_TryUnstick
...
//
    ...
    for (i=0 ; i<entity_cap ; i++, ent = NEXT_EDICT(ent))
    {
        ...
        //Fix this mess (array dereferencing)
